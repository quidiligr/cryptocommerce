...
router.get('/product-page/:guid', ProductController.product_page)
...
router.get('/category/:slug', ProductController.category_page)  
/*
router.get('/category/:id', function(req, res, next) { 
    ...
    function(err, results) {
        ...
        //console.log(`113: router.get('/category/:id) results= ${JSON.stringify(results,null,4)}`)
        ...
        console.log(`114: router.get('/category/:id) data= ${JSON.stringify(data,null,4)}`)
